...
<body>
  ...
  if(isset($_GET['id'])) {
    ...
    if($categ->voirCateg($_GET['id'])) {
      if($categ->suppCateg($_GET['id'])){
        ViewTemplate::alert("success", "Categorie supprimée avec succès", "liste-categ.php");
      }
      else{
        ViewTemplate::alert("danger", "Echec de la suppression", "liste-categ.php");
      }
    }
    else {
      ViewTemplate::alert("danger", "La categorie n'existe pas", "liste-categ.php");
    }
  }
  else {
