...
if (isset($_POST['id'], $_POST['quantite']) && is_numeric($_POST['id']) && is_numeric($_POST['quantite'])) {
    ...
    header('location: liste-produit.php?page=panier');
    exit;
}
...
if (isset($_POST['placerCommande']) && isset($_SESSION['panier']) && !empty($_SESSION['panier'])) {
    header('Location: liste-produit.php?page=placerCommade');
    exit;
}
...
?>
	   ...
	   <div class="panier content-wrapper">
	       ...
	       <form action="liste-produit.php?page=panier" method="post">
	           <table>
	              <thead>
	                  <tr>
	              ...
	              <tbody>
	                  ...
	                  <tr>
	                      <td class="img">
	                          <a href="liste-produit.php?page=produit&id=<?=$produit['id']?>">
	                              <img src="imgs/<?=$produit['photo']?>" width="50" height="50" alt="<?=$produit['nom']?>">
	                          </a>
	                      </td>
	       <td><a href="liste-produit.php?page=produit&id=<?=$produit['id']?>"><?=$produit['nom']?></a>
	                          <br>
	                          <a href="liste-produit.php?page=panier&remove=<?=$produit['id']?>" class="remove"><i class="fas fa-trash">&nbsp;</i>Supprimer </a></td>
