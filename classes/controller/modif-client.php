...
<body>
  ...
  if (isset($_GET['id'])) {
    if ($client->voirClient($_GET['id'])) {
      ...
      ViewTemplate::alert("danger", "Le client  n'existe pas", "page-client.php");
    }
  } else {
    ...
    if (isset($_POST['id']) && $client->voirClient($_POST['id'])) {
      if ($client->modifClient($_POST['id'], $_POST['nom'], $_POST['prenom'], $_POST['mail'], $pass, $_POST['tel'], $_POST['adresse'], $_POST['ville'], $_POST['code_post'], $_POST['token'])) {
        ViewTemplate::alert("success", "Le client a été modifié avec succès", "page-client.php");
      } else {
        ViewTemplate::alert("danger", "Echec de la modification", "page-client.php");
      }
    } else {
      ViewTemplate::alert("danger", "Aucune donnée n'a été transmise", "page-client.php");
    }
  }
